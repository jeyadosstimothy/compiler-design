...
union YYSTYPE
{
#line 13 "for.y" /* yacc.c:355  */

	char *str;

#line 133 "for.tab.c" /* yacc.c:355  */
};
...
{
  "$end", "error", "$undefined", "FOR", "OP", "CL", "OP1", "CL1", "TEXT",
  "SC", "UNR", "DO", "WHILE", "$accept", "ss", "s", "for", "$@1", "stmt",
  "dwhile", "$@2", YY_NULLPTR
};
#endif
...
{
      13,    14,    15,     9,     1,    10,    11,    12,    26,     2,
      16,    19,     3,    18,    20,    21,    25,    23,    22,    24,
      28,    27,    29,     0,    32,    31,    33
};
...
{
       0,     3,     8,    11,    14,    15,    16,    18,    19,     4,
       9,     6,     0,    15,    15,    15,     8,    20,     9,    15,
       8,     7,     9,    12,     8,     4,     5,     8,     6,     5,
      17,     9,    15,     7
};
...
#line 1268 "for.tab.c" /* yacc.c:1646  */
    break;
...
#line 31 "for.y" /* yacc.c:1646  */
    {
				...
				start.pop_back();
				start.push_back(x);
				s.insert(start.back(),strcat((yyvsp[-2].str),"){\n"));
				s=s+"\n}";
				start.pop_back();
			}
#line 1283 "for.tab.c" /* yacc.c:1646  */
    break;


#line 1287 "for.tab.c" /* yacc.c:1646  */
      default: break;
    }
